...
?>
    <div class="hero-wrap js-fullheight" style="background-image: url('../../../../assets/img/menu/bg_1ss.png');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
          	<h2 class="subheading">Ketahui Usia Kandungan Mu !</h2>
          	<h1 class="mb-4">Ayo Mulai Hitung !</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <section class="ftco-section ftco-book ftco-no-pt ftco-no-pb">
    	<div class="container">
	    	<div class="row justify-content-end">
	    		<div class="col-lg-4">
						<form method="POST"  action="hasil_usia/" class="appointment-form">
							<h3 class="mb-3">Kalkulator Usia Kandungan</h3>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
			    					<div class="input-wrap">
			            		<div class="icon"><span class="ion-md-calendar"></span></div>
			            		<input type="text" class="form-control appointment_date-check-in" name="tanggal" placeholder="Hari Pertama Haid Terakhir">
		            		</div>
			    				</div>
                </div>
                <div class="col-md-12">
									<div class="form-group">
			    					<input type="text" name="waktu" class="form-control" placeholder="Lama Siklus Haid">
			    				</div>
                </div>
                <div class="col-md-12">
									<div class="form-group">
	                      ...
	                      <select name="status" class="form-control">
	                      	<option value="">Siklus Haid</option>
	                        <option value="Normal">Teratur</option>
	                        <option value="Lainnya">Tidak Teratur</option>
	                      </select>
	                    </div>
			              </div>
			    				</div>
								...
								<div class="col-md-12">
									<div class="form-group">
			              <input type="submit" name="submit" value="Hitung Perkiraan Kelahiran" class="btn btn-primary py-3 px-4">
			            </div>
								</div>
							</div>
	    			</form>
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                ...
                <p><a href="/HIHEALTH/menu/artikel/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                ...
                <p><a href="/HIHEALTH/menu/referensi/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                ...
                <p><a href="/HIHEALTH/menu/kalkulator/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                ...
                <p><a href="/HIHEALTH/menu/konsultasi/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../../../assets/img/menu/covid.jpg);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">UPDATE COVID</h3>
                <p>Yuk Update Berita Covid Terbaru !</p>
                <p><a href="/HIHEALTH/menu/covid/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                ...
                <p><a href="/HIHEALTH/USER GUIDE WEBSITE HITKHEALTH.pdf" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
        </div>
