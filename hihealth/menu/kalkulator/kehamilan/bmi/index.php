	    	...
	    	<div class="row justify-content-end">
	    		<div class="col-lg-4">
						<form method="POST" action="hasil_bmi/" class="appointment-form">
							<h3 class="mb-3">Kalkulator Perhitungan BMI</h3>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
			    					<input type="text" name="bb" class="form-control" placeholder="Berat Badan Sebelum Hamil (kg)">
			    				</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
			    					<input type="text" name="tb" class="form-control" placeholder="Tinggi Badan (cm)">
			    				</div>
                </div>
                <div class="col-md-12">
									<div class="form-group">
			    					<input type="text" name="uh" class="form-control" placeholder="Usia Kehamilan (Minggu)">
			    				</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
