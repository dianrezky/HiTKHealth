...
?>
<div class="hero-wrap js-fullheight" style="background-image: url('../../../../assets/img/menu/bg_1ssa.jpg');" data-stellar-background-ratio="0.5">
      <div class="overlay"></div>
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
          	<h2 class="subheading">Ketahui Perkiraan Kelahiran Anak Mu !</h2>
	    	...
	    	<div class="row justify-content-end">
	    		<div class="col-lg-4">
						<form method="POST"  action="hasil/" class="appointment-form">
							<h3 class="mb-3">Kalkulator Perkiraan Kelahiran</h3>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
			    					<div class="input-wrap">
			            		<div class="icon"><span class="ion-md-calendar"></span></div>
			            		<input type="text" class="form-control appointment_date-check-in" name="tanggal" placeholder="Hari Pertama Haid Terakhir" required>
		            		</div>
			    				</div>
                </div>
                <div class="col-md-12">
									<div class="form-group">
			    					<input type="text" name="waktu" class="form-control" placeholder="Lama Siklus Haid" required>
			    				</div>
                </div>
                <div class="col-md-12">
									<div class="form-group">
