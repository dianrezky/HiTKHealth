...
<section class="ftco-section ftco-services">
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../assets/img/menu/bmbi.png);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">Kalkulator BMI</h3>
                <p>Yuk ketahui Berat Badan Idealmu Dengan Hitung BMI Sekarang Juga !</p>
                <p><a href="bmi/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../assets/img/menu/bmr.png);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">Kalkulator BMR</h3>
                <p>Yuk ketahui Kalori Yang Dibutuhkan Oleh Tubuhmu Sekarang Juga !</p>
                <p><a href="kalori/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../assets/img/menu/kalori.png);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">Kalkulator Pembakaran Kalori</h3>
                <p>Yuk Ketahui Berapa Kalori Yang Terbakar Dalam Suatu Kegiatan !</p>
                <p><a href="kegiatan/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../assets/img/menu/hamils.jpg);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">Kalkulator Untuk Kehamilan</h3>
                <p>Yuk Hitung Berat Badan Ideal Untuk Ibu Hamil, dll Disini !</p>
                <p><a href="kehamilan/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../assets/img/menu/wanita.png);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">Kalkulator Untuk Wanita</h3>
                <p>Yuk Hitung Siklus Haid dan Masa Kesuburan Mu Disini !</p>
                <p><a href="wanita/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../assets/img/menu/abmrr.png);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">Kalkulator Detak Jantung</h3>
                <p>Yuk Ketahui Detan Jantung Normal dan Maksimal Mu</p>
                <p><a href="jantung/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
        </div>
