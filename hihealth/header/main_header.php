...
if(isset($_SESSION['status'])){
    if($_SESSION['level']=="admin"){
        $adding = "<a href='/HIHEALTH/admin/dashboard/'>Home</a>";
    }else if($_SESSION['level']=='doctor'){
        $adding = "<a href='/HIHEALTH/dokter/dashboard/'>Home</a>";
    }else{
        $adding = "<a href='/HIHEALTH/'>Home</a>";
    }
}
...
function generate_nav($add){
    if(isset($_SESSION['status'])){
        ...
        ?>
            <li><a>Profile</a>
                <ul class='submenu'>
                    <li><a href='/HIHEALTH/user/dashboard/edit_profile.php'>Edit Profile</a></li> 
        ...
        ?>
            <li><a>Profile</a>
                <ul class='submenu'>
                    <li><?php echo "$add"?></li>
                    <li><a href='/HIHEALTH/dokter/dashboard/edit_profile.php'>Edit Profile</a></li> 
                    <li><a href='/HIHEALTH/user/logout.php'>Logout</a></li>
                </ul>
            </li>
        <?php
