...
?>
    <main>
        <div class="main-container" style="margin-top:0px; margin-left:150px">
            ...
            <a class="btn btn-primary" href="/menu/konsultasi/konsultasi_dokter/" name="newQuestion" style="margin:25px 0px 25px 0px;">Kembali Ke Menu Sebelumnya</a>
            ...
            ?>
                <div class="related-topic-card">
                    ...
                    <div class="topic-container">
                        <a href="/menu/konsultasi/konsultasi_dokter/detail/index.php?id=<?php echo $id ?>">
                            ...
                            <div class="topic-title">
                                ...
                                <div class="topic-by">
                                    <a href="/menu/konsultasi/konsultasi_dokter/detail/index.php?id=<?php $row['id'] ?>"><?php  ?></a>
                                </div>
                            </div>
                    </div>
                    <div class="topic-detail">
                        <p class="title"><a href="/menu/konsultasi/konsultasi_dokter/detail/index.php/?id= <?php echo $id ?>">
                            </a></p>
                        <div>
                            <p><?php echo $row['post_excerpt'] ?></p>
                        </div><a href="/menu/konsultasi/konsultasi_dokter/detail/index.php?id=<?php echo $id ?>">
                        </a>
                        <p></p>
                    </div>
                </div>
