                            ...
                            <div class="main-menu f-right d-none d-lg-block">
                                <nav>
                                    <ul id="navigation">
                                        ...
                                        <li><a href="/menu/artikel/forum/">FORUM</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-do text-center mb-30">
                            ...
                            <div class="do-btn">
                                <a href="/menu/artikel/forum/"><i class="ti-arrow-right"></i>FIND ME</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                    ...
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-xl-5 col-lg-3 col-md-12">
                            <div class="wantToWork-btn f-right">
                                <a href="/USER GUIDE WEBSITE HITKHEALTH.pdf" class="btn btn-ans">Download disini</a>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-xl-12 ">
                                <div class="footer-copy-right text-center">
                                    <p>
                                        ...
                                        </script> All rights reserved <i class="ti-heart" aria-hidden="true"></i> by HiTKHealth </p>
                                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                    </p>
                                </div>
                            </div>
