...
<section class="ftco-section ftco-services">
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                ...
                <p>Yuk ketahui Berat Badan Idealmu Semasa Hamil !</p>
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                <h3 class="heading">Kalkulator Usia Kehamilan</h3>
                <p>Yuk ketahui Usia Kehamilan Mu !</p>
                <p><a href="usia/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>    
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="media-body py-4 px-3">
                <h3 class="heading">Kalkulator Perkiraan kelahiran</h3>
                <p>Yuk Ketahui Perkiraan Hari Kelahiran Mu !</p>
                <p><a href="lahir/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
        </div>
