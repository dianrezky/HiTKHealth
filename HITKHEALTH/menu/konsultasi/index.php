...
<section class="ftco-section ftco-services">
          ...
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../assets/img/menu/symtom.png);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">Cek Gejala Penyakit</h3>
                <p>Lakukan tes untuk mengenali gejala penyakit</p>
                <p><a href="analisa_gejala" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              <div class="img" style="background-image: url(../../assets/img/menu/Konsultasi.jpg);"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">Konsultasi</h3>
                <p>Konsultasi dengan dokter!</p>
                <p><a href="konsultasi_dokter/" class="btn btn-primary">FIND ME</a></p>
              </div>
            </div>      
          </div>
        </div>
