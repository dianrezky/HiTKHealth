...
<head>
    ...
    <title>Sign Up Website HiHealth</title>
            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <form method="POST" class="register-form" id="register-form" action="cek_register.php">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="ps" id="pass" placeholder="Password"/>
                            </div>
                            <div class="form-group">
                                <label for="name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                    ...
                    <div class="signup-image">
                        ...
                        <br></br>
                        <p>Jika Kamu Sudah Mendaftar dan Kamu Adalah Seorang Dokter, Hubungan Kami <a href="#">Disini</a></p>
                    </div>
                </div>
            </div>
        </section>
